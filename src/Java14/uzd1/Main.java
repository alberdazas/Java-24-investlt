...
//        Spausdinti(list, "Pradinis list");
    ...
    public static void PridetiReiksmeMap(Map<Integer,Double> map, Saskaita obj) {
        switch (obj.getSaskaitosData().getMonthValue()) {
            ...
            case 2:
            case 3: {
                // Tikriname ar mape jau yra idetas pirmas ketvirtis
                if(map.containsKey(1)) {
                    Double suma = map.get(1) + obj.getSuma().doubleValue();
                    map.put(1, suma);
                } else {
                    map.put(1, obj.getSuma().doubleValue());
                }
